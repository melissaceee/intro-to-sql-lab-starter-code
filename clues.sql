...
FROM countries WHERE region = 'Southern Europe'
...
FROM countrylanguages WHERE countrycode = 'VAT';

-- Clue #3: We have new news on the classes Carmen attended – our gumshoes tell us she's moved on to a different country, a country where people speak only the language she was learning. Find out which nearby country speaks nothing but that language.

-- Write SQL query here
SELECT countries.name, countrylanguages.language AS language, countrylanguages.percentage AS percentage
FROM countries
...
FROM cities
WHERE name != 'San Marino' AND countrycode = 'SMR';
...
WHERE cities.countrycode != 'SMR' AND cities.name LIKE 'Serra%';
...
WHERE cities.countrycode = 'BRA' AND countries.code = 'BRA'
...
FROM cities WHERE population = 91084;